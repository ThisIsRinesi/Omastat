...
The TUI intentionally uses terminal ANSI palette slots instead of embedded RGB
colors. Terminal themes generated by matugen/Skwd-wall can restyle the dashboard
without an Omastat-specific theme file.
