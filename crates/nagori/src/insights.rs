...
/// Dashboard-only occurrence of a learned routine. The flattened finding keeps
/// existing evidence consumers compatible while timing has a dedicated contract.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Prediction {
    pub id: String,
    pub strength: PredictionStrength,
    pub generated_at: i64,
    pub display_from: i64,
    pub display_until: i64,
