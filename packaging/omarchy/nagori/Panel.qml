...
import "InsightCopy.js" as Copy

Ui.Panel {
  id: root
  moduleName: "local.nagori"
  manageIpc: false
  ...
  onInsightClockChanged: {
    if (inspectedInsight && inspectedInsight.kind === "upcoming-activity" && Model.visiblePredictions([inspectedInsight], insightClock, "", "").length === 0) closeInsight()
  }
              ...
              ColumnLayout {
                ...
                Repeater {
                  ...
                  Controls.AbstractButton {
                    ...
                    Accessible.name: Copy.predictionTitle(modelData, root.insightTone, root.todayKey) + ". " + Copy.insightSummary(modelData, root.insightTone, root.insightCopyDate)
                    ...
                    contentItem: ColumnLayout {
                      ...
                      Label { Layout.fillWidth: true; text: Copy.predictionTitle(predictionButton.modelData, root.insightTone, root.todayKey); wrapMode: Text.Wrap; font.bold: true; font.pixelSize: Style.font.subtitle }
                      Label { Layout.fillWidth: true; text: predictionButton.modelData.value; color: root.accent; font.bold: true }
                      Label { Layout.fillWidth: true; text: Copy.insightSummary(predictionButton.modelData, root.insightTone, root.insightCopyDate); wrapMode: Text.Wrap; color: root.dim }
                    }
                  }
                }
                Label {
                ...
                GridLayout {
                  ...
                  Repeater {
                    ...
                    Controls.AbstractButton {
                      ...
                      activeFocusOnTab: true
                      Accessible.name: Copy.insightHeading(modelData, root.insightTone, root.insightCopyDate) + ". " + presentation.value + ". " + presentation.frequency
                      ...
                      contentItem: ColumnLayout {
                        ...
                        RowLayout {
                          Layout.fillWidth: true
                          Label { Layout.fillWidth: true; text: Copy.insightHeading(insightButton.modelData, root.insightTone, root.insightCopyDate); wrapMode: Text.Wrap; font.bold: true; font.pixelSize: Style.font.body }
                        ...
                        Label { Layout.fillWidth: true; text: Copy.insightSummary(insightButton.modelData, root.insightTone, root.insightCopyDate); wrapMode: Text.Wrap }
                      }
                    }
                  }
                }
                ...
                ColumnLayout {
                  ...
                  Label { Layout.fillWidth: true; text: Copy.insightHeading(insightDetail.item, root.insightTone, root.insightCopyDate); wrapMode: Text.Wrap; font.pixelSize: Style.font.subtitle; font.bold: true }
                  ...
                  Label { Layout.fillWidth: true; text: Copy.insightSummary(insightDetail.item, root.insightTone, root.insightCopyDate); wrapMode: Text.Wrap }
